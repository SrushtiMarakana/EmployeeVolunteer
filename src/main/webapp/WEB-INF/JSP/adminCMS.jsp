...
<%@ page import="com.tatvasoft.volunteer.model.CMS_Page"%>
<%@ page language="java"
        ...
        <div class="row" style="padding:0%;margin:0%;">
          ...
          <div class="col-10 col-sm-9" style="padding: 0%;">
            ...
            <div class="adminStyle11">
              <div class="text-end">
                <a href="adminAddCMS" class="adminStyle12 rounded-pill btn btn-outline-warning" style="box-shadow: none;">
...
<%
    			...
    			List<CMS_Page> cmsPage = (List<CMS_Page>)request.getAttribute("cmsPage");
    			for(CMS_Page cms : cmsPage){
    				String status = "Active"; 
    				if(cms.getStatus() != true){
    					status = "In-Active";
    				}
%>
                    <tr>
                      <td><%=cms.getCms_title()%></td>
                      <td style="color:#14c506;"><%=status%></td>
                      <td>
                        <a href="adminEditCMS/<%=cms.getCms_page_id()%>"><img src="/resources/Assets/edit.jpg" alt="..." height="17px" width="17px"></a>&nbsp;&nbsp;&nbsp;<a href="#ConfirmDelete_<%=cms.getCms_page_id()%>" data-bs-toggle="modal" aria-controls="ConfirmDelete"><img src="/resources/Assets/bin.png" alt="..." height="17px"></a>
                      </td>
                    </tr>
<%
    			}
...
%>
    <!--Confirm Delete-->
    <div class="modal modalConfirmDelete fade" id="ConfirmDelete_<%=cms.getCms_page_id()%>" aria-hidden="true" aria-labelledby="ConfirmDeleteLabel" tabindex="-1">
        <div class="modal-dialog" style="margin-top: 150px;">
          <div class="modal-content" style="padding: 20px;">
            ...
            <form action="deleteCMSByAdmin" method="Post">
            <div class="modal-body">
              <div class="row">
                <div class="col-12">
                	<input type="hidden" name="cmsPageId" value="<%=cms.getCms_page_id()%>">
