    ...
    <div class="container-fluid" style="margin: 0%;padding:0%;">
        <div class="row" style="padding:0%;margin:0%;">
          ...
          <div class="adminStyle11">
             <div>
<%
				CMS_Page cms = (CMS_Page)request.getAttribute("cmsPage");
   				
%>
                <form action="updateCMSByAdmin" class="row g-3" method="Post">
                	<input type="hidden" name="cmsPageId" value="<%=cms.getCms_page_id()%>">
                    <div class="col-12">
                      <label for="title" class="form-label mb-0">Title</label>
                      <input type="text" class="form-control admin-input" style="box-shadow: none;" placeholder="Enter CMS Page Title" name="title"  value="<%=cms.getCms_title()%>" required>
                    </div>
                    <div class="col-12">
                        <label for="Description" class="form-label">Description</label>
          
                        <textarea class="form-control admin-input" style="box-shadow: none;" name="Description" id="editor" placeholder="Enter CMS Page Description" rows="3"><%if(cms.getCms_description() != "None"){ out.println(cms.getCms_description());}%></textarea>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" class="form-control admin-input" style="box-shadow: none;" placeholder="Enter slug" name="slug" value="<%if(cms.getSlug() != "None"){ out.println(cms.getSlug());}%>">
                    </div>
                    <div class="col-12">
