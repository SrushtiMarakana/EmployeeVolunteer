...
<%@ page import="com.tatvasoft.volunteer.model.Users"%>
...
%>
               <form action="updateUserByAdmin" method="post" enctype="multipart/form-data" class="row g-3">
               		<input type="hidden" name="userId" value="<%=users.getUser_id()%>">
                    <div class="col-lg-6">
                      <label for="fname" class="form-label mb-0">First Name*</label>
                      <input type="text" class="form-control admin-input" style="box-shadow: none;" placeholder="Enter firstname" name="fname" value="<%=users.getFirst_name()%>" required>
                    </div>
                    <div class="col-lg-6">
                      <label for="lname" class="form-label mb-0">Last Name*</label>
                      <input type="text" class="form-control admin-input" style="box-shadow: none;" placeholder="Enter lastname" name="lname" value="<%=users.getLast_name()%>" required>
                    </div>
                    <div class="col-lg-6">
                        <label for="email" class="form-label mb-0">Email*</label>
                        <input type="email" class="form-control admin-input" style="box-shadow: none;" placeholder="Enter email" name="email" value="<%=users.getEmail()%>" required>
                    </div>
                     <div class="col-lg-6">
                    	<label for="password" class="form-label mb-0">Password*</label><br>
                   		<input type="password" name="password" minlength="8" maxlength="10" class="form-control admin-input " style="box-shadow: none;"  required value="<%=users.getPassword()%>" placeholder="Enter password">
                	</div>
              		<div class="col-12">
                		<label for="avatar" class="form-label mb-0">Upload Your Photo</label><br>
						<input type="file" name="avatar"  class="form-control admin-input" accept="image/jpeg,image/png, image/jpg" style="box-shadow: none;" value="<%=users.getAvatar()%>">
                    ...
                    <div class="col-lg-6">
                      ...
                      <input type="text" class="form-control admin-input" style="box-shadow: none;" placeholder="Enter employee id" value="<%if(users.getEmployee_id() != null){ out.println(users.getEmployee_id());}%>" name="EmployeeID">
                    </div>
                    <div class="col-lg-6">
                      <label for="Department" class="form-label mb-0">Department</label>
                      <input type="text" class="form-control admin-input" style="box-shadow: none;" placeholder="Enter department" value="<%if(users.getDepartment() != null){ out.println(users.getDepartment());}%>" name="Department">
                    </div>
...
%>
              		...
              		<div class="col-12">
                		...
                		<textarea class="form-control admin-input" style="box-shadow: none;" placeholder="Enter comments..." name="ProfileText" rows="3"><% if(users.getProfile_text() != null){ out.println(users.getProfile_text());}%></textarea>
              		</div>
                    <div class="col-12">
